...
1.	Datasets for the study consist of six types
    ...
    (2)	Routes.xlsx: tourists visit the tour route

    (3)	Sentimentclass：classification of sentiments categories 

    (4) Travelers.xlsx: Visitor and Book Information

    (5) Place.xlsx:A comparison between the names of places in the book and the present ones
